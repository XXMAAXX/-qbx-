...
^4Welcome to ^3OverX^4!
To learn more, please check out the documentation at ^5https://discord.gg/MeU4xjPsWU^4.
To turn this message off, set the ^3OVERX-XMAX^4 convar to true in your server.cfg file.^7]]
    end
